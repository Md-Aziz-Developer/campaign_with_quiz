...
class QuestionController extends Controller
{
    ...
    public function show(Campaign $campaign, Question $question): JsonResponse
    {
        $this->authorize('update', $campaign);
    ...
    public function update(StoreQuestionRequest $request, Campaign $campaign, Question $question): JsonResponse|RedirectResponse
    {
        $this->authorize('update', $campaign);
        if ($question->campaign_id !== $campaign->id) {
            abort(404);
        ...
        return redirect()->route('admin.campaigns.questions', $campaign)->with('success', 'Question updated.');
    }
