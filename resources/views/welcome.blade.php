...
<body class="bg-light">
    ...
    <main class="container py-5">
        <div class="hero p-5 mb-5 text-center">
            ...
            <p class="lead mb-2 opacity-90">Create surveys, collect responses, and view reports in one place.</p>
            <p class="small opacity-75 mb-4">Sign in as admin to create campaigns and add questions. Share the campaign link with participants to collect answers and view results.</p>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text text-muted small">Build surveys with multiple question types: MCQ (single or multiple choice), text, and number with scoring rules.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text text-muted small">Share a link; participants enter their details and answer one question at a time. Control whether repeat submissions are allowed.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text text-muted small">See participant list, per-question scores, and full answer breakdown. Export results to CSV for analysis.</p>
                    </div>
                </div>
            </div>
        </div>
